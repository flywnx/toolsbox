...
exports.uploadImg = async (ctx) => {
  ...
  function upload() {
    ...
    let key = "/12345678900.PNG";

    var mac = new qiniu.auth.digest.Mac(
      "PLVbNZJZW55mYBoLq4D8boZgO5xrTeBTqTCKHqER",
      "7C6I0uWsRqRe1KooSW5pP4iu494Ae_aQ28sBSyXT"
    );
    ...
    return new Promise((resolved, reject) => {
      formUploader.putFile(
        token,
        key,
        "../server/src/9922720e0cf3d7cae04b09132ede790c6a63a959.jpeg",
        extra,
